...
- [~] T039 [US2] Implement appointment confirmation email service `backend/src/services/AppointmentService.ts` - **SKIPPED (time constraint)** - Send Spanish-language confirmation email within 2 minutes of booking (SC-011), include appointment details, unique reference number, doctor info, instructions
